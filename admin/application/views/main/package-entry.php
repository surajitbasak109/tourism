		...
		<div class="content-wrapper">
			...
			<div class="content">
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							<form action="<?= base_url('/main/packageentry'); ?>" id="entryForm" method="POST" enctype="multipart/form-data" autocomplete="off">
								...
								<div class="form-group row">
									...
									<div class="col-md-8">
										<div class="row">
											...
											<div class="col-md-10">
												<input type="text" name="title" id="title" placeholder="Enter Package Title" class="form-control col-form-label" value="<?= set_value('title'); ?>" autofocus="true">
											</div>
											<?= form_error('title'); ?>
										</div>
									</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-10">
										<textarea name="description" id="description" rows="2" class="form-control"><?= set_value('description'); ?></textarea>
									</div>
								...
								<div class="form-group row">
									<div class="col-md-4">
										<div class="row">
											...
											<div class="col-md-6">
												<input type="number" name="rate_per" id="rate_per" value="<?= set_value('rate_per', '0.00'); ?>" class="form-control text-right">
											</div>
											<?= form_error('rate_per'); ?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="row">
											...
											<div class="col-md-6">
												<input type="number" name="nights" id="nights" value="<?= set_value('nights', 1); ?>" class="form-control text-right">
											</div>
											<?= form_error('nights'); ?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="row">
											...
											<div class="col-md-6">
												<input type="number" name="days" id="days" value="<?= set_value('days', '2'); ?>" class="form-control text-right" readonly>
											</div>
											<?= form_error('days'); ?>
										</div>
									</div>
								...
								<div class="form-group row">
									<div class="col-md-4">
										<div class="row">
											...
											<div class="col-md-6">
												<input type="number" name="min_pax" id="min_pax" value="<?= set_value('min_pax', '1'); ?>" class="form-control text-right">
											</div>
											<?= form_error('min_pax'); ?>
										</div>
									</div>
											...
											<div class="col-md-6">
												<select name="tag" id="tag" class="form-control select2">
													...
													<?php foreach ($tags as $tag) : ?>
														<option value="<?= $tag->name ?>" <?= set_select('tag', $tag->name, TRUE); ?>><?= $tag->name; ?></option>
													<?php endforeach ?>
												</select>
											</div>
											<?= form_error('tag'); ?>
										...
										<div class="input-group">
											<span class="input-group-btn">
												<span class="btn btn-default btn-file">
													Browse… <input type="file" id="imgInp" name="imageInp" accept="image/x-png,image/gif,image/jpeg" required>
												</span>
											</span>
											<input type="text" name="imgPath" class="form-control" readonly>
										</div>
										<img class="img-responsive mt-2" id='img-upload' />
										<?= form_error('imgInp'); ?>
									</div>
								</div>
							</form>
